...
class ColData:
    def __init__(self, f):
            ...
            self.num_vertices = read_u16(f)
            _ = read_u16(f)
            self.vertex_tbl = read_u32(f)
            self.num_polys = read_u16(f)
            _ = read_u16(f)
...
def print_col_data(f, col_data):
    ...
    print('min_z: {:.1f}'.format(col_data.min_z))
    print('amount_x: {}'.format(col_data.amount_x))
    print('amount_y: {}'.format(col_data.amount_y))
    print('amount_z: {}'.format(col_data.amount_z))
    print('length_x: {:.1f}'.format(col_data.length_x))
    print('length_y: {:.1f}'.format(col_data.length_y))
    print('length_z: {:.1f}'.format(col_data.length_z))
    print('lookup_tbl: 0x{:08X}'.format(col_data.lookup_tbl))
    print('node_max: 0x{:04X}'.format(col_data.node_max))
    print('node_count: 0x{:04X}'.format(col_data.node_count))
    print('node_tbl: 0x{:08X}'.format(col_data.node_tbl))
    print('poly_check_tbl: 0x{:08X}'.format(col_data.poly_check_tbl))
    print('dyna_poly_tbl: 0x{:08X}'.format(col_data.dyna_poly_tbl))
    print('dyna_vertex_tbl: 0x{:08X}'.format(col_data.dyna_vertex_tbl))
    print('num_vertices: {}'.format(col_data.num_vertices))
    print('vertex_tbl: 0x{:08X}'.format(col_data.vertex_tbl))
    print('num_polys: {}'.format(col_data.num_polys))
    print('poly_tbl: 0x{:08X}'.format(col_data.poly_tbl))
    print('surface_type_tbl: 0x{:08X}'.format(col_data.surface_type_tbl))
